...
export interface IImmoProps extends StateProps, DispatchProps, RouteComponentProps<{}> {numero:string}
  ...
  return (
    <div>
      ...
      <Row className="justify-content-start">
        <Col md="8">
          <br />
        <h3><strong>Immobilisation</strong></h3>
        </Col>
      </Row>
      <br />
          ...
          {immobilisationList.map((immobilisation, i) => (
            <AvForm key={`entity-${i}`} >
                <AvGroup >
                  ...
                  <AvInput id="Immobilisation-immo" value={immobilisation.immo}  type="text" className="form-control" name="numero" required readOnly />
                </AvGroup>
              <Row className="justify-content-center">
                <Col md="10">
              ...
              <AvGroup>
                ...
                <AvField id="prepaImmo-patente" type="text" value="0,00%" name="taux_patente" />
              </AvGroup>
              <AvGroup>
              ...
              <AvField type="select" name="ancCompte" value={immobilisation.ancCompte} label="Compte" >
