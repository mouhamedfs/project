            ...
            <AvForm key={`entity-${i}`}>
              ...
              <Row className="justify-content-end">
                <Col md="5">
                  &nbsp;
                  {prepaImmo.etat !== 'M' ? (
                    <Button tag={Link} color="primary" id="save-entity" type="submit" disabled>
                      <FontAwesomeIcon icon="save" /> &nbsp;
                      <Translate contentKey="entity.action.save">Save</Translate>
                    </Button>
                  ) : (
                    <Button tag={Link} to={`${match.url}/${prepaImmo.numero}/valid`} color="primary" id="save-entity" type="submit">
                      <FontAwesomeIcon icon="save" /> &nbsp;
                      <Translate contentKey="entity.action.save">Save</Translate>
                    </Button>
                  )}
